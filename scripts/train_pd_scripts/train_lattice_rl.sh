...
do
  ...
  CUDA_VISIBLE_DEVICES=2 python ../train/train_lattice.py --env_dim ${env_dim} --algorithm_name ${algo} --log_interval 1 --num_env_steps 8000 \
      ...
      --experiment_name ${exp} --use_render --use_wandb --lr 0.1 --video_interval 2 --use_linear_beta_decay --replay_scheme 'prioritized' --learning_starts 100 \
      ...
      --interact_pattern 'together' --compare_reward --n_eval_rollout_threads 2
