...
do
  ...
  CUDA_VISIBLE_DEVICES=2 python ../train/train_lattice.py --env_dim ${env_dim} --algorithm_name ${algo} --log_interval 5 --num_env_steps 60000 \
      ...
      --experiment_name ${exp} --use_render --lr 0.1 --video_interval 10 --use_linear_beta_growth --replay_scheme 'prioritized' --learning_starts 200 \
      ...
      --exploration_fraction 0.03 --strategy_final_exploration 0.05 --tau 0.01 
done
